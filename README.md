Here is an amazing project I worked on setting up a CICD pipeline using Github, Slack, Jenkins, Maven, Sonarqube, Nexus, Ansible, Prometheus, Grafana from scratch to automate the deployment process of our java app into the Dev-Env, Stage-Env and Prod-Env. 
